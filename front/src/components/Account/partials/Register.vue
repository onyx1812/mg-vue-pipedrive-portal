  ...
  <div class="content content-register">
      <form @submit="formSubmit" id="register" class="form form-register">
        ...
        <ul class="fields">
          ...
          <li class="field">
            <input type="text" name="city" v-model="city" placeholder="Город" required>
          </li>
          <li class="field">
            <input type="text" name="address" v-model="address" placeholder="Адресс" required>
          </li>
          <li class="field">
        ...
        <div>Have account? <a @click="accLogin">Login</a></div>
          ...
          .then(
            (user => {
              ...
              if(user == false){
                ...
                this.email = null;
                this.error = true;
                this.error_msg = 'This email already used';
                document.getElementById('email').value = '';
                setTimeout(()=>{
                  this.error = false;
                }, 1500);
              } else {
                // let user_data = sessionStorage.setItem('USER_DATA', JSON.stringify(user[0]));
